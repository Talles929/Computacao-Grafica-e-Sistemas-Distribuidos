...
<html >
  ...
  <section id="container" >
      ...
      <header class="header dark-bg">
            ...
            <!--logo start-->
            <a href="novoUsuario.php" class="logo">Swagger <span class="lite">Universidade de Itaúna</span></a>
            <!--logo end-->
                  ...
                  <div class="col-lg-12">
                      <section class="">
                          ...
                          <div class="panel-body">
                              <form class="form-horizontal" role="form" action="novoUsuario.php" method="post">
								  ...
								  <div class="form-group">
                                      <div class="col-lg-offset-1 col-lg-10">
                                          <input type="submit" Name=Cadastra class="btn btn-primary">
